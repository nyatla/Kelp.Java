package jp.nyatla.kelpjava.j2se;
...
public class BinaryReader
{
	...
	public static byte[] toArray(File i_file) throws IOException
	{
		return toArray(new FileInputStream(i_file));
	}
	public static byte[] toArray(InputStream i_stream) throws IOException
	{
